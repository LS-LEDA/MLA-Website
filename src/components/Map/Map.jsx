...
const Map = () => {
  const roadmap = [
    ...
    {
      message:
        'Micro-services back-end with API. Better data processing performance and additional features.',
    },
    {
    ...
    <div className="min-h-screen w-full py-6 flex flex-col justify-center sm:py-12">
      <div className="py-3 sm:max-w-xl sm:mx-auto w-full px-2 sm:px-0">
        <div className="relative text-gray-700 antialiased text-sm font-semibold">
          {/* Middle vertical bar*/}
          <div className="hidden sm:block w-1 bg-indigo-400 absolute h-full left-1/2 transform -translate-x-1/2"></div>
            ...
            return (
              <div className="mt-10 sm:mt-0 sm:mb-12" key={index}>
                <div className="flex flex-col sm:flex-row items-center">
                  ...
                  {/* Circle */}
                  <div
                    className="rounded-full bg-indigo-300 border-white border-4 w-10 h-10
