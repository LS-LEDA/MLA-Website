...
const Features = () => {
  const features = [
    {
      ...
      description:
        'MLA works across operating systems. Use it on OS X, Windows or Linux.',
    ...
    },
    {
      title: 'Private',
      description:
        'Process all the data in your local computer. Your data is yours and only yours.',
  ...
  const customizations = [
    {
      title: 'Plugins',
      description:
        'Enhance and power-up MLA with plugins. Add extra features to the application.',
      icon: <SiDatabricks size={24} />,
    },
    {
      title: 'Dark mode',
      description:
        'For night owls. Only one click away to turn everything dark. Toggle it on or off as you prefer.',
    ...
    },
    {
      title: 'Themes',
      description:
        "MLA ships pre-installed with UI themes in both dark and light colours. Can't find what you're looking for? Create your own.",
  ...
  return (
    <section
      id="features"
      className="flex flex-col min-h-screen w-full m-auto justify-center content-center gap-y-20
                                          p-20 md:px-32 lg:42 2xl:px-96 dark:bg-dark_bg dark:text-dark_text"
    >
      <div className="flex flex-col w-full h-auto space-y-10">
        <h1 className="flex text-3xl justify-center font-bold md:justify-start md:font-normal">
          {' '}
          Got you covered{' '}
        </h1>
        <div className="flex w-full h-full">
          ...
          <div className="hidden lg:flex lg:w-1/2 p-5">
            <img
              src={features[selectedFeat].img}
              alt={features[selectedFeat].title}
            />
          </div>
        </div>
      </div>
